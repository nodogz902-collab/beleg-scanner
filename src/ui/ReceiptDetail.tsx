...
export function ReceiptDetail() {
  ...
  async function share() { await sharePdf(r!.pdfBlob, `Beleg-${r!.belegdatum}.pdf`) }
  ...
  return (
    <div style="padding:var(--sp-4);display:grid;gap:var(--sp-4)">
      ...
      <div class="card">
        ...
        <Field label="Einscannungsdatum"><input type="date" value={r.einscannungsdatum ?? ''} onChange={e => { const v=(e.target as HTMLInputElement).value; if (!v) return; persist({ einscannungsdatum: v }) }} /></Field>
